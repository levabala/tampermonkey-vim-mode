...
(() => {
  ...
  class DOMTextMetrics {
    ...
    getLineHeight() {
      ...
      return isNaN(height) ? this.getFontSize() * 1.2 : height;
    }
  }
...
`, lineStartInSelection);
  ...
  function scrollIfNeeded(input) {
    ...
    const viewportHeight = rect.height || textarea.clientHeight || parseFloat(computedStyle.height) || 200;
